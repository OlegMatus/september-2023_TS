...
// }
// Task-6 Створити інпут який приймає вік людини та кнопку яка підтверджує дію.При натисканні на кнопку зчитати інформацію з інпуту та перевірити вік чи менше він ніж 18, та повідомити про це користувача
const form1 = document.forms['f2'] as HTMLFormElement;
form1.addEventListener('submit',  function (ev: Event) {
    ev.preventDefault();
    // const ageElement = document.querySelector('#ageInput input') as HTMLInputElement;
    const ageElement = document.getElementById('ageInput') as HTMLInputElement;
if (Number(ageElement.value) < 18) {
    return alert('You are not 18 years old');
}
